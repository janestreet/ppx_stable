...
module Variant_basic_stackify = struct
  ...
  module V2 = struct
    ...
    include struct
      ...
      let to_V1_t__stack ~modify_B ~modify_C ~modify_D (v : t) : V1.t =
        Stable_variant.Helper.map
          v
          ~a:(fun () -> V1.A)
          ~b:modify_B
      ...
      let of_V1_t__stack ~modify_B ~modify_C ~modify_D (v : V1.t) : t =
        V1.Stable_variant.Helper.map
          v
          ~a:(fun () -> A)
          ~b:modify_B
